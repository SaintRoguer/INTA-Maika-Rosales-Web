...
function Sesiones() {
  console.log("Llegue aca - sesiones");
  ...
  return (
    <div>
      {tableData && tableData.length > 0 ? (
              ...
              <Card>
                    ...
                    <div>
                      ...
                      {tableData.length === 1 ? (
                        <p className={classes.cardCategoryWhite}>
                          Hay <span style={{ color: "yellow" }}>1 sesión creada.</span>
                        </p>
                      ) : (
                        <p className={classes.cardCategoryWhite}>
                          Hay <span style={{ color: "yellow" }}>{tableData.length} sesiones creadas.</span>
                        </p>
                      )}
                    </div>
                ...
                <CardBody>
                  <Table
                    ...
                    tableHead={[
                      { accessorKey: "description", header: "Descripción", size: "auto" },
                      { accessorKey: "date", header: "Fecha", enableEditing: false, size: "auto" },
                      { accessorKey: "creator", header: "Creada por", enableEditing: false, size: "auto" },
                      { accessorKey: "numberOfLotes", header: "Cantidad de lotes", enableEditing: false, size: "auto" },
                    ]}
                    tableData={tableData}
                  />
                </CardBody>
        ...
        <>
          <h1 style={{ fontWeight: "bold" }}>Todavía no hay sesiones creadas</h1>
          <h3>
            ¡Bajá la{" "}
            <a href="https://drive.google.com/file/d/1R1gTdAKPZS6O2zv4WeTZM3sDXDmmssq3/view?usp=sharing" target="_blank">
              app
            </a>{" "}
