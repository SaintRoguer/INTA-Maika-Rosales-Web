...
export default function AlarmModal({ open, onClose, onSubmit, windVelocity, soilSensitivity, loteDetailId }) {
  ...
  console.log("AlarmModal render windVelocity", windVelocity);
  console.log("AlarmModal render soilSensitivity", soilSensitivity);
  ...
  const handleFormSubmit = (data) => {
    onSubmit(Number(data.windVelocity), Number(data.soilSensitivity), loteDetailId);
  };
