...
export async function setEolicErosionCoefficients(req, res, sessionId) { 
  try {
    ...
    if (typeof soilSensitivity !== 'number' || typeof soilSensitivity !== 'string' || soilSensitivity < 0 || soilSensitivity > 5) {
      return res.status(400).json({ error: "Invalid soil sensitivity data format" });
    }
